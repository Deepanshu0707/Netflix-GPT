...
const VideoTitle = ({title, overview}) => {
  return (
    <div className='absolute top-0 bottom-0 pt-[225px] pl-[40px] z-10 text-white bg-gradient-to-r from-black '>
...
{/* <div className='absolute pt-[18%] pl-[50px] z-10 text-white bg-gradient-to-r from-black w-screen h-screen'>
      <h1 className='text-[50px] font-bold'>{title}</h1>
      <p className='w-1/4 -mt-5 py-6 text-[17px]'>{overview}</p>
      <div>
        <button className='bg-white text-black p-3 px-10 rounded-lg text-lg font-bold opacity-90'>Play</button>
